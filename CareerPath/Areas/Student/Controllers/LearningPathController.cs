...
//         }
//
//         // ── 2. Load latest analysis with feature vector ──────────────────────
...
//         }
//
//         // ── 3. Call Python API with structured data ──────────────────────────
//         try
//         {
//             var result = await _pythonApiServices.LearningPathGenerationAsync(
//                 analysis.FeatureVector, slug);
//
//             if (result is null)
//             {
...
//         catch (Exception ex)
//         {
//             _logger.LogError(ex, "[LearningPath/Generate] Failed for slug={Slug}", slug);
